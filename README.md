...
- Diagnóstico AS-IS de maturidade em testes;
- Implantação de processos de QA;
- Estruturação de fluxo no Azure DevOps;
- Criação de Definition of Done com critérios de qualidade;
- Padronização de documentação e evidências de testes;
- Implantação de métricas e rastreabilidade;
- Criação de matriz RACI;
- Estudos de TMMi;
- Criação de política, estratégia e planejamento de testes;
- POC para escolha de ferramenta de automação;
- Onboarding de novos colaboradores de QA;
